...
def main():
    ...
    match model_type:
        case "LlamaCpp":
            llm = LlamaCpp(model_path=model_path, n_ctx=model_n_ctx, callbacks=callbacks, verbose=True, n_gpu_layers=750)
        case "GPT4All":
            if is_gpu_enabled:
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Zerg: Ask questions to your documents without an internet connection, '
